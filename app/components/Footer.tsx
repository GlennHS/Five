  ...
  return (
    <footer className="w-full border-t border-slate-200 bg-white">
      <div className="mx-auto flex max-w-sm flex-col items-center gap-2 px-4 py-2">
        ...
        <a href="https://www.ko-fi.com/aetherswitch" className="bg-pink-200 active:bg-pink-400 transition-colors duration-300 px-4 py-1 rounded-xl border text-xs font-bold flex gap-1 items-center"><Heart size={16} strokeWidth={2} fill="#f77" />Support Me!</a>
      </div>
    </footer>
  );
}